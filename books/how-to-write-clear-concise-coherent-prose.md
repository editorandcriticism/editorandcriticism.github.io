...
Here's a summary of how to write clear, concise, and coherent prose. For brevity, this section tells you what to do without showing you how. For demonstrations and examples of the suggestions listed here, see the references cited at the end, especially _Style: Toward Clarity and Grace_, by Joseph M. Williams, whose work is informed by research in linguistics and psychology. 

When faced with an unfamiliar platform or application architecture, readers try to create a holistic picture of it --- or, more formally, a mental or cognitive model. They attempt to attach the unfamiliar aspects of it to things they already know. They want to know what it is, what it does, how it works, and why. What requirements does it entail? What use cases does it serve? What problems does it solve? Why should they care? 

So: How can you relate new technology to something readers already know? For complex platforms or emerging technology, the key is to present critical information in a way that creates global coherence. But how do you do that? 
...
* _The Sense of Style_, by Steven Pinker, who also supplies a quotation to end this guide with a reminder to balance a focus on style with more important things in life: 
