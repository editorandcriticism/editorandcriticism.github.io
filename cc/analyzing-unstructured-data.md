---
title: Notes on Using Big Data Analytics to Mitigate Security Risks
---

_Blog Post: 2010: A Big Data Odyssey_
...
* Developing a pipeline to aqgregate unstructured data for analysis
* Integrating the analytics engine with storage systems that contain the source data to make it available without comprosing performance
* Tools for processing, manipulation, queries, and analysis
* The ability to export results into a standard database for additional queries and processing
* The ability to scale the processing cluster to handle extremely large sets of unstructured data.
* Including access control to secure the analytics system

#### Result: Producing Business Intelligence from Big Data
...
<i class="fa fa-info" aria-hidden="true"></i> _Notes from 2010._
